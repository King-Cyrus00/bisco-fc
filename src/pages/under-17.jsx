...
import player1 from '../assets/images/big.png'; 


export default function Under17Team() {
  const players = [
  ...
  return (
    <section className="py-10 bg-gray-100">
      <h1 className="text-center text-3xl font-bold mb-8 text-[#0D47A1]">Under 17 Team</h1>
