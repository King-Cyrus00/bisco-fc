...
// Lazy load the player image
const PlayerImage = React.lazy(() => import('../pages/management-image'))
  ...
  return (
    <div className="relative group w-72 sm:w-80 md:w-96 rounded-xl overflow-hidden bg-gradient-to-b from-[#0D47A1] via-[#E30613] to-[#ffffff] shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-500">
      ...
      <div className="absolute bottom-0 left-0 w-full text-center py-5">
        <h2 className="text-6xl font-extrabold text-white drop-shadow-md leading-none">13</h2>
        <h3 className="text-2xl font-bold text-white mt-2 tracking-wide">SATORANSKY</h3>
        <p className="text-sm text-white uppercase mt-1">Guard</p>
      </div>
